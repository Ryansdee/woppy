 ...
 <section id="features" className="py-24 px-6 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
    ...
    <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.2 }} className="bg-white/80 backdrop-blur-lg border border-[#d8c8ff] rounded-3xl p-8 sm:p-12 shadow-xl max-w-6xl mx-auto">
      ...
      {/* ========================
          PAIEMENT STRIPE
      ======================== */}
<section id="pricing" className="py-24 px-6 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      {/* Background decorative elements */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <h2 className="text-5xl font-bold text-[#4C3E87] mb-6 leading-tight">
              Paiement sécurisé et <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">transparent</span>
            </h2>

            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Woppy utilise <strong className="text-[#6772E5]">Stripe Connect</strong> pour garantir la sécurité et la fluidité de chaque transaction entre étudiants et clients.
            </p>

            {/* Commission breakdown card */}
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-6 rounded-2xl mb-8 border border-purple-100">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Commission plateforme</p>
                  <p className="text-3xl font-bold text-purple-600">15%</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-600 mb-1">Reversé à l'étudiant</p>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Sécurité garantie</h3>
              ...
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform">
                ...
                <div>
                  <p className="font-medium text-gray-800">Aucune donnée bancaire stockée</p>
                  <p className="text-sm text-gray-600">Vos informations restent chez Stripe</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform">
                ...
                <div>
                  <p className="font-medium text-gray-800">Conforme PSD2 / SCA</p>
                  <p className="text-sm text-gray-600">Authentification forte requise</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform">
                ...
                <div>
                  <p className="font-medium text-gray-800">Paiements instantanés</p>
                  <p className="text-sm text-gray-600">Versement rapide aux étudiants</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-8 group-hover:shadow-purple-200 transition-shadow duration-500">
                {/* Stripe logo mockup */}
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 bg-[#6772E5] rounded-xl flex items-center justify-center">
                    <Shield className="text-white w-6 h-6" />
                  </div>
                  <div>
                    <p className="font-bold text-gray-800 text-lg">Stripe Connect</p>
                    <p className="text-sm text-gray-500">Paiements sécurisés</p>
                  </div>
                </div>

                {/* Payment card mockup */}
                <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl p-6 text-white mb-6 shadow-xl">
                  <div className="flex justify-between items-start mb-8">
                    <div className="w-12 h-10 bg-yellow-400 rounded" />
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-2">
                      {[...Array(4)].map((_, i) => (
                        <div key={i} className="flex gap-1">
                          {[...Array(4)].map((_, j) => (
                            <div key={j} className="w-2 h-2 bg-white/60 rounded-full" />
                          ))}
                        </div>
                      ))}
                    </div>
                    <div className="flex justify-between items-end">
                      <div>
                        ...
                        <p className="font-semibold">Étudiant Woppy</p>
                      </div>
                      <p className="text-sm opacity-90">12/27</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Paiement validé</p>
                      <p className="text-sm text-gray-600">Transaction sécurisée</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-xl text-gray-800">45,00 €</p>
                    <p className="text-xs text-gray-500">38,25 € net</p>
                  </div>
                </div>
              </div>

              {/* Decorative blur effects */}
              <div className="absolute -bottom-6 -right-6 w-72 h-72 bg-gradient-to-br from-purple-400/30 to-indigo-400/30 blur-3xl rounded-full -z-10 group-hover:scale-110 transition-transform duration-700" />
              <div className="absolute -top-6 -left-6 w-48 h-48 bg-gradient-to-br from-purple-300/20 to-pink-300/20 blur-2xl rounded-full -z-10" />
            </div>
          </div>
        </div>
      </div>
